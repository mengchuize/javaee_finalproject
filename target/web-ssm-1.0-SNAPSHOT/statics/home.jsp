        ...
        <div class="sidebar-inner slimscrollleft">
            ...
            <div id="sidebar-menu">
                <ul>
                    ...
                    <li>
                        <a href="${pageContext.request.contextPath}/statics/teacherhome.jsp" class="waves-effect"><i class="mdi mdi-swap-horizontal"></i><span>作业管理</span></a>
                    </li>
                    <li>
                        <a href="${pageContext.request.contextPath}/statics/studenthome.jsp" class="waves-effect"><i class="mdi mdi-wallet"></i><span>学生管理</span></a>
                    </li>
    ...
    <div class="content-page">
        ...
        <div class="content">
            ...
            <div class="page-content-wrapper ">
                <img style="width: 1500px" src="${pageContext.request.contextPath}/statics/image/home.jpg">
