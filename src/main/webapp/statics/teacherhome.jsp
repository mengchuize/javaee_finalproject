							...
							<div class="row">
                                <div class="col-md-12 col-xl-6">
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title" style="font-weight: bolder">作业管理</h4>
                                            <button class="btn btn-success" onclick="addh()" style="margin-left: 0">新建作业</button>
                                    ...
                                    <div class="card m-b-30">
                                        <div class="card-body">
                                            <h4 class="mt-0 header-title" style="font-weight: bolder">学生管理</h4>
                                            <button class="btn btn-success" onclick="adds()" >增加学生</button>
                                            <div class="table-responsive-sm mt-2">
                                                <table class="table table-hover">
                                                    <thead>
                                                    <tr>
                                                        <th scope="col" class="border-top-0"><b>姓名</b></th>
                                                        <th scope="col" class="border-top-0"><b>用户名</b></th>
                                                        <th scope="col" class="border-top-0"><b>密码</b></th>
                                                        <th scope="col" class="border-top-0"><b>操作</b></th>
                                                    </tr>
